    ...
    <table class="table-view">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border-data"><b>Rata-Rata</b></td>
                <td class="border-data"><b>{{ $data_nilai['rata_rata']['nilai'] }}</b></td>
                <td class="border-data"><b>{{ $data_nilai['rata_rata']['grade'] }}</b></td>
            </tr>
        </tbody>
    </table>
</center>
